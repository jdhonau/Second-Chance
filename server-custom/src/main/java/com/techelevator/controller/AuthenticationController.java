...
public class AuthenticationController {
    ...
    public AuthenticationController(TokenProvider tokenProvider, AuthenticationManagerBuilder authenticationManagerBuilder, UserDao userDao, JdbcUserDao jdbcUserDao) {
    ...
    public User register(@Valid @RequestBody RegisterUserDto newUser) {
        ...
        try {
            User user = jdbcUserDao.createUser(new User(newUser.getUsername(), newUser.getPassword(), newUser.getRole()));
            return user;
        }
        catch (DaoException e) {
            throw new ResponseStatusException(HttpStatus.INTERNAL_SERVER_ERROR, "DAO error - " + e.getMessage());
